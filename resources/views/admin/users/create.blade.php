        ...
        <div class="bg-white shadow rounded-lg">
            ...
            <form method="POST" action="{{ route('admin.users.store') }}" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" required class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                </div>
